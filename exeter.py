...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(
            name="spileUwU | Prefix: " + str(Exeter.command_prefix),
            icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(
            url=
            "https://tenor.com/view/alexandra-daddario-gif-18683663"
        )
        embed.add_field(
            name="\uD83E\uDDCA `HELP GENERAL`",
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/843823262575624243/843878871639654480/IMG_20210517_212246.JPG"
        )
